...
<html>
    ...
    <body onload="changeTheme(songarr,'../images/soothing.png')">
		<header>
			<div>
			...
			<div>
				<span style="color:white;" id="no_users"></span>
				<?php 
        ...
        <div class="outer">
            ...
            <div class="sec">
				...
				<div class="player" style="padding:20px;">
					...
					<button style="border:none;outline:none;background-color:black" onclick="playPause()"><img src="../images/pause.png" id ="pause" name ="pause" class="playpause" alt="play/pause"/></button>
				</div>
            </div>
        </div>
